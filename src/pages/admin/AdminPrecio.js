...
export const AdminPrecio = () => {
    ...
    return (
        <div  className='container mb-8 p-5 mt-8'>
            <div className="columns is-multiline">
                <div className="column is-12 box-center text-center">
                    <h1 className='title is-4' >FIJAR PRECIO AL PRODUCTO <br/> TECNICA DE PRECIO PROMEDIO:</h1>
                </div>
                ...
                <div className="column is-6">
                    ...
                    <h1 className='title is-3 box-center text-center' >Precio promedio: $52 <br/> Ganancia: $52 - 11.6 = $40.6</h1>
                </div>
            </div>
        </div>
    )
